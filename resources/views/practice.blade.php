                                ...
                                <div class="ms-3 w-100 accordion-header" id="opinion{{ $opinion->id }}">
                                    ...
                                    <div class="mt-2 is-flex is-flex-direction-row justify-content-between">
                                        ...
                                        <div class="mt-2 is-flex is-flex-direction-row">
                                            <div class="p-2 is-size-7 mr-2 accordion-button collapsed " data-bs-toggle="collapse"
                                                data-bs-target="#comments{{ $opinion->id }}" aria-expanded="false"
                                                aria-controls="comments{{ $opinion->id }}">
                                                {{ $opinion->comments->count() }}
                                                {{ __('practice.comments') }}
                                            </div>
                                            <div class="mr-2 accordion-button collapsed is-size-7" data-bs-toggle="collapse"
                                                data-bs-target="#refs{{ $opinion->id }}" aria-expanded="false"
                                                aria-controls="refs{{ $opinion->id }}">
